...
public class ShotSpeaker extends Command {

  private final ShooterSubsystem shooterSubsystem;

  /** Creates a new ShotSpeaker. */
  public ShotSpeaker(ShooterSubsystem shooterSubsystem) {
  ...
  @Override
  public void execute() {
    shooterSubsystem.setShooterAngle(SHOOTER_POSITIONS.SPEAKER);
    new WaitCommand(0.2);
    shooterSubsystem.setShooterMotor(1);
    new WaitCommand(0.5);
    shooterSubsystem.setTrigerMotor(1);
  }
